 ...
 * {@link Bitmap}s.
 */
public class PdfReaderFragment extends Fragment implements View.OnClickListener {
     ...
     */
    private static final String FILENAME = "sample1.pdf";

    private final static String URL1 = "http://unec.edu.az/application/uploads/2014/12/pdf-sample.pdf";
    ...
    private void openRenderer(Context context) throws IOException {
        ...
        if (!file.exists()) {
            ...
            //InputStream asset = new URL(URL1).openStream();
            FileOutputStream output = new FileOutputStream(file);
            //FileOutputStream output = new FileOutputStream(URL1);
